...
const Exercises = ({setExercises,bodyPart,exercises}) => {
  ...
  //console.log("printing the last index ",indexOfLastExercise);
 const indexOfFirstExercise = indexOfLastExercise - exercisesPerPage
  // console.log("printing the first index ",indexOfFirstExercise);

  // console.log(`printing exercises of ${bodyPart}`,exercises);
